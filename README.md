...
The suite runs offline: no model server, no network. Fourteen behaviours the tool guarantees have been
verified to actually fail when the behaviour is removed — see
